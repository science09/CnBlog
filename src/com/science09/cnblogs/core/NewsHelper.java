...
import com.science09.cnblogs.parser.NewsListXmlParser;
import com.science09.cnblogs.parser.NewsXmlParser;
...
public class NewsHelper extends DefaultHandler {
	 ...
	 * @return
	 */
	public static String ParseNewsString(String dataString) {
		SAXParserFactory saxParserFactory = SAXParserFactory.newInstance();
		String newsContent = "";
		try {
			XMLReader xmlReader = saxParserFactory.newSAXParser()
