package com.science09.cnblogs.config;

import android.os.Environment;

public class Config {
	public static final String TEMP_IMAGES_LOCATION = Environment.getExternalStorageDirectory().getPath() + "/cnblogs/images/"; // 临时图片文件
	...
	public static final String APP_PACKAGE_NAME = "com.science09.cnblogs";// 程序包名
