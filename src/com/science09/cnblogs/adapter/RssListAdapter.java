...
public class RssListAdapter extends BaseAdapter {
	...
	public RssListAdapter(Context context, List<RssList> list, EnumSource source) {
		this.source = source;
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
				...
				public void onClick(View v) {
					...
					if (v == viewHolder.list_btn_rss) {
						...
						if (_isRssed) {// 退订
							...
							viewHolder.list_btn_rss.setTextColor(context
		...
		if (isRssed) {
			...
			viewHolder.list_btn_rss.setText(R.string.btn_unrss);
			viewHolder.list_btn_rss.setTextColor(context.getResources()
